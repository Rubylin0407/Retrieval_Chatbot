...
def main(args):
    ...
    print_and_save_qka_chatgpt(question_list, docs_and_scores_list, n=args.question_n, k=args.top_k, threshold=args.threshold,model=args.model , csv_saved_path=f'metadata/inference_data/langchain_{args.model}_k{args.top_k}.csv')
